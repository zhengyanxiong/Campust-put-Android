...
public class ActionSheetDialog {
    ...
    public ActionSheetDialog builder() {
        // 获取Dialog布局
        View view = LayoutInflater.from(context).inflate(R.layout.mall_view_actionsheet, null);
        // 设置Dialog最小宽度为屏幕宽度
    ...
    private void setSheetItems() {
        ...
        // 添加条目过多的时候控制高度
        if (size >= 7) {
            WindowManager.LayoutParams params = (WindowManager.LayoutParams) sLayout_content.getLayoutParams();
