...
public class MyGoodsSellActivity extends BaseVcActivity {
    @BindView(R2.id.my_sell_goods_web_view)
    WebView webView;


    @Override
    protected int getLayoutId() {
        return R.layout.mall_activity_my_sell_goods;
    }
    ...
    public void initView() {
        ...
        webView.loadUrl(Constants.MY_SELL_GOODS_LINK);
